...
def create_enemy():
    enemy_size = (10, 10)
    enemy = pygame.image.load('enemy.png') # Surface(enemy_size)
...
def create_bonus():
    bonus_size = (15, 15)
    bonus = pygame.image.load('bonus.png') #Surface(bonus_size)
...
while playing:
    ...
    main1_display.blit(bg, (bg_X1, 0)) 
    main1_display.blit(bg, (bg_X2, 0))
    ...
    for enemy in enemies:
        ...
        main1_display.blit(enemy[0], enemy[1])
        if player_rect.colliderect(enemy[1]):
            playing = False

    for bonus in bonusies:
        bonus[1] = bonus[1].move(bonus[2])
        main1_display.blit(bonus[0], bonus[1])
